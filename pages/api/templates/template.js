export const template = (t_name, t_email, t_message) => `<!DOCTYPE html
...
<body style="padding:0; margin: 0;background: #e4e6ec">
  <table style="height: 100%; width: 100%; background-color: #e4e6ec;" align="center">
    <tbody>
      <tr>
        <td id="dbody" data-version="2.31"
          style="width: 100%; height: 100%; padding-top: 50px; padding-bottom: 50px; background-color: #e4e6ec;"
          valign="top">
          <table class="layer_1" style="max-width: 600px; box-sizing: border-box; width: 100%; margin: 0px auto;"
                  ...
                  <div class="layer_2"
                    ...
                    <table class="edcontent" style="border-collapse: collapse;width:100%" cellspacing="0" border="0">
                      <tbody>
                        <tr>
                          <td class="edtext"
                            style="padding: 10px 20px; text-align: left; color: #5f5f5f; font-size: 12px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; word-break: break-word; direction: ltr; box-sizing: border-box;"
                            valign="top">
                            <p class="style1 text-center"
                              style="text-align: center; margin: 0px; padding: 0px; color: #000000; font-size: 32px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">
                      ...
                      <tbody>
                        <tr>
                          <td class="edtext"
                            ...
                            <p style="margin: 0px; padding: 0px; font-size: 14px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">${t_name}</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          <td class="edtext"
                            ...
                            <p style="margin: 0px; padding: 0px; font-size: 14px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">${t_email}</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          <td class="edtext"
                            ...
                            <pre style="margin: 0px; padding: 0px; font-size: 14px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">${t_message}</pre>
                          </td>
                        </tr>
                      </tbody>
                    </table>
