...
export default function Contact() {
  ...
  // when captchaError is true, render empty section (same behavior as before)
  if (ctx?.captchaError) {
    return (
      <>
        ...
        <div className={styles.contactme + " " + poppins.className}>
          ...
          >
            ...
            <div className={styles.textwrapper}>
              ...
              <textarea
                className={styles.textarea + " " + poppins.className}
                name="message"
              ...
              {ctx.captchaSrc != null && (
                <div className={styles.captchaWrapper}>
                  ...
                  <div className={styles.inputGrp}>
                    ...
                    <button
                      className={
                        styles.reloadCaptcha +
                        (ctx.loading ? " " + styles.loading : "")
                      }
                      ...
                      onClick={(e) => {
                        ...
                        ctx.setTimer(() => {
                          ctx.getCaptcha();
                          return setInterval(ctx.getCaptcha, 120000);
                        });
                      }}
                    >
                      <svg
              ...
              <input
                className={styles.submit + " " + poppins.className}
                type="submit"
                value={ctx.submitBtn}
